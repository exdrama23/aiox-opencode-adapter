...
1. Check if the bug already exists in [Issues](https://github.com/AIOX-Squads/aiox-opencode-adapter/issues)
...
3. Update documentation in `docs/pt/AGENTS.md` and `docs/en/AGENTS.md`
